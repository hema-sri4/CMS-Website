...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-light fixed-top">
        <div class="container">
            <img class="navbar-brand" src="logo\nitdlogo.png" alt="logo" style="padding:0px;">
                ...
                <ul class="navbar-nav ml-auto text-dark justify-content-center">
                    <li class="nav-item active">
                        <a class="nav-link active text-dark" href="#home">
                            <h2 style="padding:5px 5px;">Home</h2>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#aboutus">
                            <h2 style="padding:5px 5px;">About Us</h2>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#classes">
                            <h2 style="padding:5px 5px;">Classes</h2>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#contactus">
                            <h2 style="padding:5px 5px;">Contact Us</h2>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <h4 class="animated zoomIn" style="animation-delay: 0.5s">NEW CAMPUS</h3>
                        <h5 class="animated zoomIn" style="animation-delay: 1s">National Institute of
                            Technology , Delhi </h4>
                    </div>
                </div>
